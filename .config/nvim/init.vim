...
execute 'source' fnamemodify(expand('<sfile>'), ':h').'/lua/nvim-lspconfig.lua'
...
execute 'source' fnamemodify(expand('<sfile>'), ':h').'/lua/nvim-lint.lua'
execute 'source' fnamemodify(expand('<sfile>'), ':h').'/lua/conform.nvim.lua'
